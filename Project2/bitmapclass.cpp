...
bool BitmapClass::InitializeBuffers(ID3D11Device* device)
{
    ...
    // 정점 버퍼를 동정으로 설정 
    // vertexBufferDesc.Usage = D3D11_USAGE_DYNAMIC;, vertexBufferDesc.CPUAccessFlags = D3D11_CPU_ACCESS_WRITE;
...
void BitmapClass::SetRenderSize(int w, int h)
{
    m_bitmapWidth = w;
    m_bitmapHeight = h;
    return;
